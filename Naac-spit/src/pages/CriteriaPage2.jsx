  ...
  const customContents = [
    {
      mainContent: "2.1.1",
      linkNames: [
        { name: "Document 1", pdf: "http://localhost:5173/Criteria/1.1.1.pdf" },
        { name: "Document 2", pdf: "http://localhost:5173/Criteria/1.1.2.pdf" },
        { name: "Document 2", pdf: "http://localhost:5173/Criteria/1.1.2.pdf" },
        { name: "Document 2", pdf: "http://localhost:5173/Criteria/1.1.2.pdf" },
        { name: "Document 2", pdf: "http://localhost:5173/Criteria/1.1.2.pdf" },
        { name: "Document 2", pdf: "http://localhost:5173/Criteria/1.1.2.pdf" },
  ...
  return (
    <>
      <div className="hello h-[37rem] w-[55rem] mt-[2rem] transform -translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 bg-white border border-solid border-blue-900 rounded-lg p-3 overflow-y-auto">
        <h1 className="text-[3rem] text-blue-900 font-extrabold">CRITERIA 2</h1>
